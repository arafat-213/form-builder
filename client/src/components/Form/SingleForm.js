	...
	return (<Form>
		...
		<Fragment>
			...
			<FloatingLabel controlId="floatingName" label="Name">
				<Form.Control type="text" placeholder="Enter your name here" className="mb-3"/>
			</FloatingLabel>
		</Fragment>

		{/* Questions from currentForm */}
		{ currentForm?.questions?.map(({questionTitle, options, answerType}) =>
			<Fragment>
				<h5 className="mb-2">{ questionTitle }</h5>
				{/* If answerType is Text, render a text input */ }
				{ answerType === 1 &&
					<Form.Control size="lg" type="text" placeholder="Type your response here" />
				}
		...
		<Button variant="success" className="p2 mx-1">Submit Respone</Button>
		<Button variant="outline-secondary" className="p-2">Discard</Button>
